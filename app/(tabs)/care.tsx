...
const careCategories = [
  { id: '1', icon: Pill, label: 'Medications', count: 3, color: colors.primary[600] },
  { id: '2', icon: Syringe, label: 'Vaccinations', count: 2, color: colors.status.healthy },
  { id: '3', icon: Scissors, label: 'Grooming', count: 1, color: colors.status.caution },
  { id: '4', icon: Bath, label: 'Hygiene', count: 2, color: colors.primary[500] },
  { id: '5', icon: Calendar, label: 'Appointments', count: 1, color: colors.status.urgent },
  { id: '6', icon: Heart, label: 'Wellness', count: 4, color: colors.status.healthy },
];
